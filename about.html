...
<body>
    ...
    <div id="about-us">
        ...
        <div class="container">
            ...
            <div class="row" style="margin-right: 0; margin-left: 0;" data-aos="fade-up" data-aos-delay="500">
                <div>
                    ...
                    <p>Welcome to my personal travel blog, i love to travel the globe, i have been to so <a href="#">many beautiful</a>...e world, this website is my mirror of life. Welcome to my personal travel blog, i love to travel the globe, i have been to so many beautiful... Welcome to my personal travel blog, i love to travel the globe, i have been to so many beautiful places and met interesting people around the world, this website is my mirror of life. </p>
                    <p>Welcome nal travel blog, i love to travel the globe, i have been to so <a href="#">many beautiful</a> Welcome to my personal travel blog, i love to travel the globe, i have been to so many beautiful places and met interes Welcom y personal travel blog, i love to travel the globe, i have been to so many beautiful places and met interesting people around the world, this website is my mirror of life.</p>
                    <p>Welcome to my personal travel blog, i love to travel the globe, i have been to so <a href="#">many beautiful</a>...e world, this website is my mirror of life. </p>
                    <p>Welcome to my personal travel blog, i love to travel the globe, i have been to so <a href="#">many beautiful</a>......</p>
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-12 right-part">
                    <ul class="ml-auto">
                        ...
                        <li><a class="hidden-xs">-</a></li>
                        <li class="nav-item"><a class="nav-link" href="services.html">Men</a></li>
                        <li><a class="hidden-xs">-</a></li>
                        <li class="nav-item"><a class="nav-link" href="technology.html">Kids</a></li>
                        <li><a class="hidden-xs">-</a></li>
                        <li class="nav-item"><a class="nav-link" href="portfolio.html">Gifts</a></li>
                        <li><a class="hidden-xs">-</a></li>
                        <li class="nav-item"><a class="nav-link" href="blog.html">Blog</a></li>
                        <li><a class="hidden-xs">-</a></li>
                        <li class="nav-item"><a class="nav-link" href="contact.html">Contact</a></li>
