...
<body>
    ...
    <section class="single">
        ...
        <hr>
        <div class="container">
            <h3 data-aos="fade-up" data-aos-delay="300">Awesome Product Heading</h3>
            <p data-aos="fade-up" data-aos-delay="400">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of </p>
            <div class="row myrow" data-aos="fade-up" data-aos-delay="500">
                    ...
                    <div id="myCarousel" class="carousel slide">
                        ...
                        <div class="carousel-inner">
                            <div class="item carousel-item active" data-slide-number="0">
                                <img src="images/chair4.jpg" alt="image" class="img-fluid w549">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="images/chair1.jpg" alt="image" class="img-fluid w549">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="images/chair3.jpg" alt="image" class="img-fluid w549">
                            </div>
                            <div class="item carousel-item" data-slide-number="3">
                                <img src="images/chair2.jpg" alt="image" class="img-fluid w549">
                            </div>
                        </div>
                        ...
                        <ul class="carousel-indicators list-inline">
                            <li class="list-inline-item active">
                                <a id="carousel-selector-0" class="selected" data-slide-to="0" data-target="#myCarousel">
                                    <img src="images/chair4.jpg" alt="image" class="w98">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-1" data-slide-to="1" data-target="#myCarousel">
                                    <img src="images/chair1.jpg" alt="image" class="w98">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-2" data-slide-to="2" data-target="#myCarousel">
                                    <img src="images/chair3.jpg" alt="image" class="w98">
                                </a>
                            </li>
                            <li class="list-inline-item">
                                <a id="carousel-selector-3" data-slide-to="3" data-target="#myCarousel">
                                    <img src="images/chair2.jpg" alt="image" class="w98">
                                </a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="myreview" data-aos="fade-up">
                            ...
                            <div class="review-content">
                                ...
                                <p>Wow...Wow.....i really like the way you write the articles about your photography, they are really awesome thanks a lot for sharing</p>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    <section class="another-Featured-Products">
        <div class="container">
            <h3>Featured Products</h3>
            <div class="row" data-aos="fade-up" data-aos-delay="300">
                <div class="col-lg-3 col-md-6 col-12 gallery">
                    <figure>
                        <img src="images/product-1.jpg" alt="" class="img-thumbnail" />
                        <figcaption>
                            <div class="content">
                ...
                <div class="col-lg-3 col-md-6 col-12 gallery">
                    <figure>
                        <img src="images/product-2.jpg" alt="" class="img-thumbnail" />
                        <figcaption>
                            <div class="content">
                                <h4><a href="product_single.html">$34.00 <span>Swimming Wear</span></a></h4>
                                <ul>
                ...
                <div class="col-lg-3 col-md-6 col-12 gallery">
                    <figure>
                        <img src="images/product-3.jpg" alt="" class="img-thumbnail" />
                        <figcaption>
                            <div class="content">
                                <h4><a href="product_single.html"><span>$34.00 <span>Swimming Wear</span></span></a></h4>
                                <ul>
                                    <li><a href="product_single.html"><i class="fa fa-shopping-cart" aria-hidden="true"></i></a></li>
                                    <li><a href="product_single.html"><i class="fa fa-eye" aria-hidden="true"></i></a></li>
                                    <li><a href="product_single.html"><i class="fa fa-heart" aria-hidden="true"></i></a></li>
    ...
    <section class="blog">
        <div class="container">
            <div class="meddle" style="padding-top: 10px;">
                <div class="row">
                    <div class="col-md-12">
                ...
                <div class="row">
                    <div class="col-md-6" data-aos="fade-right" data-aos-delay="300">
                        <figure class="box-1">
                            <img src="images/middle-1.jpg" alt="" class="img-responsive">
                            <figcaption>
                                <h5 class="card-title"><a href="product_single.html">Get Discount</a></h5>
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
                                <a href="product_single.html" class="btn btn-primary">learn more</a>
                            </figcaption>
                        </figure>
                    </div>
                    <div class="col-md-6" data-aos="fade-left" data-aos-delay="300">
                        <figure class="box-2">
                            <img src="images/middle-2.jpg" alt="" class="img-responsive">
                            <figcaption>
                                <h5 class="card-title"><a href="product_single.html">Get Discount</a></h5>
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh.</p>
                                <a href="product_single.html" class="btn btn-primary">Limited Offer</a>
                            </figcaption>
                        </figure>
                    </div>
                </div>
