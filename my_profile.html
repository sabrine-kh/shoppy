...
<body>
    ...
    <section class="my-profile">
        ...
        <div class="container">
            ...
            <div class="row main-content" data-aos="fade-up" data-aos-delay="500">
                <div class="col-md-2 col-12">
                    <figure class="box-2">
                        <img src="images/blog-3.jpg" alt="" width="100%" class="img-responsive">
                    </figure>
                </div>
                <div class="col-md-10 col-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-8">
                            <p><span>:</span>Hyden@ursite.com</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-9 col-8">
                            <p><span>:</span>#3204, This Building, Beside that tall building</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-4">
                        ...
                        <div class="col-md-9 col-8">
                            <p><span>:</span>#3204, This Building, Beside that tall building This state... USA</p>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-3 col-4">
