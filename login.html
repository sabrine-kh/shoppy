            ...
            <form class="form-horizontal" data-aos="fade-up" data-aos-delay="400">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                                <input type="text" name="name" class="form-control" id="name" placeholder="Enter Your Name" required autofocus/><span>*</span>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                            <div class="input-group mb-2 mr-sm-2 mb-sm-0">
                               <input type="password" class="form-control" name="psw"  placeholder="Enter your Pasword" required autofocus/><span>*</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-12 button-1">
                        ...
                        <span>Not Registered? <a href="register.html">Register Here</a></span>
                    </div>
                </div>
            </form>
        </div>
